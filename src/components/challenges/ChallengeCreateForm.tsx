...
export default function ChallengeCreationForm() {
  ...
  const { createChallenge } = useChallenges(token);
  ...
  const handleSubmit = async () => {
    ...
    const materials = analysisResult?.materials.map((m) => m.color);
    ...
    <div className="max-w-6xl mx-auto p-6 space-y-6">
      <div className="text-center space-y-2">
        ...
        <p className="text-muted-foreground">
          Upload an image to automatically detect and extract materials for your
          challenge
        </p>
      </div>
      ...
      {analysisResult && analysisResult.materials.length > 0 && (
        <Card>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Your materials have been analyzed. Click below to create the
                  challenge.
                </p>
              </div>
